...
public class Player : MonoBehaviour, ICharacter
{
    ...
    public int ManaThisTurn
    {
        ...
        set
        {
            if (value < 0)
                manaThisTurn = 0;
            else if (value > PArea.manaPoolVisual.Crystals.Length)
                manaThisTurn = PArea.manaPoolVisual.Crystals.Length;
            else
                manaThisTurn = value;
    ...
    public int ManaLeft
    {
        ...
        set
        {
            if (value < 0)
                ...
                manaLeft = PArea.manaPoolVisual.Crystals.Length;
            else
                manaLeft = value;
    ...
    public virtual void OnTurnStart()
    {
        ...
        foreach (CreatureLogic cl in table.monstersOnTable)
            cl.OnTurnStart();
    }
    ...
    public void PlayACreatureFromHand(ICardLogic playedCard, int tablePos)
    {
        ...
        table.monstersOnTable.Insert(tablePos, newCreature);
    ...
    public void LoadCharacterInfoFromAsset()
    {
        ...
        PArea.avatarVisual.charAsset = charAsset;
        PArea.avatarVisual.ApplyLookFromAsset();
    }

    public void TransmitInfoAboutPlayerToVisual()
    {
        PArea.avatarVisual.gameObject.AddComponent<IDHolder>().uniqueID = PlayerID;
